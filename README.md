...
This project was designed as an Information Professional Practicum (IPP). The IPP was completed as a work-integrated course for the Master of Information (MI) program at the Faculty of Information (University of Toronto). 

Stage 1 - Population of UVic Faculties, Departments, Schools in Wikidata
Stage 2 - Population of UVic Campus Buildings and Building Namesakes 
...
### _**How has the UVic campus expanded over time?**_
...
The University of Victoria Libraries is a participant in the [PCC Wikidata Pilot]. It is hoped that this project will demonstrate the potential applications of Wikidata for academic institutions and support future Wikidata initiatives at the University of Victoria. 
